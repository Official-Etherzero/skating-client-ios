...
+ (instancetype)modelWithTitle:(NSString *)title rowType:(SettingRowType)rowType visible:(BOOL)visible {
...
+ (instancetype)modelWithTitle:(NSString *)title rowType:(SettingRowType)rowType {
    SettingRowModel *row = [[SettingRowModel alloc] init];
    row.title = title;
    row.rowType = rowType;
    return row;
...
+ (instancetype)modelWithTitle:(NSString *)title desc:(NSString *)desc rowType:(SettingRowType)rowType {
    SettingRowModel *row = [[SettingRowModel alloc] init];
    row.title = title;
    row.rowType = rowType;
    row.desc = desc;
...
+ (instancetype)modelWithTitle:(NSString *)title value:(NSNumber *)value rowType:(SettingRowType)rowType {
    SettingRowModel *row = [[SettingRowModel alloc] init];
    row.title = title;
    row.rowType = rowType;
    row.value = value;
