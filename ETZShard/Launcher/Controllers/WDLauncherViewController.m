...
//    self.imageView.image = [UIImage imageNamed:@"logo"];
    ...
    [self.createButton addTarget:self action:@selector(userRegister) forControlEvents:UIControlEventTouchUpInside];
    ...
    [self.importButton addTarget:self action:@selector(userLogin) forControlEvents:UIControlEventTouchUpInside];
...
- (UIButton *)createCustomButton {
    ...
    [btn.titleLabel setFont:FONT_PingFangSC_BLOD_30];
    [btn setBackgroundColor:COLOR_ffffff];
    [btn setTitleColor:COLOR_3d5afe forState:UIControlStateNormal];
