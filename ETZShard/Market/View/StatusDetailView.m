...
- (instancetype)initWithOrderModel:(OrderModel *)model status:(OrderStatus)status {
    if (self = [super init]) {
        ...
        YYLabel *titleView = [[YYLabel alloc] initWithFont:FONT_PingFangSC_Heavy_36 textColor:COLOR_1a1a1a text:orderTitle];
        ...
        YYLabel *addressTitleView = [[YYLabel alloc] initWithFont:FONT_DESIGN_24 textColor:COLOR_1a1a1a_A05 text:addressTitle];
        ...
        YYLabel *usdtAddressTitleView = [[YYLabel alloc] initWithFont:FONT_DESIGN_24 textColor:COLOR_1a1a1a_A05 text:usdtAddressTitle];
