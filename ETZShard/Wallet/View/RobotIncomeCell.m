...
- (void)setModel:(MinerIncomeModel *)model {
    _model = model;
    self.timeView.text = model.RetDate;
    self.incomeView.text = [NSString stringWithFormat:@"+ %@ UBI",[[NSString stringWithFormat:@"%f",model.Ret] yy_holdDecimalPlaceToIndex:4]];
}
