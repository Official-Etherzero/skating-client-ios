...
- (instancetype)initWithNodeDetailModel:(NodeModel *)model {
    if (self = [super init]) {
        ...
        YYLabel *outputView = [[YYLabel alloc] initWithFont:FONT_DESIGN_22 textColor:COLOR_ff5959 text:[NSString stringWithFormat:@"%ld%@",(long)model.Earnings,@"%"]];
        ...
        self.textView.placeholder = YYStringWithKey(@"请输入安全密码");
