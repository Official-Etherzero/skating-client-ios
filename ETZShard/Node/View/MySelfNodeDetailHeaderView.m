...
@interface MySelfNodeDetailHeaderView ()
...
@implementation MySelfNodeDetailHeaderView
...
- (void)setModel:(NodeDetailModel *)model {
    ...
    self.totalEarningView.text = model.Reward;
    self.lastEarningView.text = [NSString stringWithFormat:@"+%@",model.RewardYesterday];
