...
@interface YYTutorialWebViewController ()
...
@implementation YYTutorialWebViewController

- (instancetype)initWithLoadingUrlString:(NSString *)urlSring {
    if (self = [super init]) {
        self.urlString = urlSring;
    }
    return self;
}
